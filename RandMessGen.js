...
let funFact = [
    ...
    'the Roman - Persian wars are the longest in history, lasting over 680 years'
];
...
let songSuggestion = [
    ...
    "Coco Mango Diced, by Damu the Fudgemunk, featuring artis MF DOOM", 
